        ...
        <div id="donate" className="w-full py-16 bg-white text-center fade-in transition-opacity duration-1000 opacity-0 translate-y-4">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="fade-in transition-opacity duration-1000 opacity-0 translate-y-4 mt-8 mx-auto max-w-2xl p-8 bg-accent text-white rounded-lg flex flex-col items-center justify-center mb-20">
              ...
              <a href="/contact/" className="bg-white text-secondary px-6 py-3 rounded-md font-semibold hover:bg-secondary hover:text-white transition-colors duration-300 text-lg sm:text-xl md:text-2xl lg:text-2xl">
                GET INVOLVED
              </a>
            </div>
          </div>
