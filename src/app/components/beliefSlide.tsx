    ...
    <div className="p-4 md:p-16">
      <div className="relative flex flex-col md:flex-row items-center justify-center bg-white">
        <div className="relative flex flex-col md:flex-row items-center justify-end w-full md:w-auto pr-4 md:pr-12">
          ...
          <div className="bg-[#98ccd6] text-white p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-md shadow-lg z-10 w-full max-w-screen-lg h-auto mt-4 md:mt-0 md:-ml-24 flex flex-col justify-center items-center relative overflow-hidden">
